...
The green ‘Add User’ button at the bottom of the page allows to create new users. The red ‘delete’ button at the end of each row corresponding to each user allows to delete that particular user. The button in the edit column for each user allows to edit the details of the corresponding user.
